...
const PageContent = () => (
  <div>
    ...
    <div className="board even">
      <div className="col-12 col-m-6 col-l-4 queue column center">
        <img src={Pic} alt="" className="content-pic" />
      </div>
      <div className="col-12 col-m-6 col-l-5 queue column">
        ...
        <p>
          ...
          {' '}
          Here you can schedule a session and connect with a professional in any area,
          {' '}
          from a nurse to a guitarrist, exchanging ideas about anything.
        </p>
      </div>
    </div>
  </div>
